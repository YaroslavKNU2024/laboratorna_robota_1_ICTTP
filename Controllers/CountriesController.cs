...
namespace LabaOne.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public CountriesController(DBFinalContext context)
        {
            _context = context;
        }
        ...
        {
            var country1 = await _context.Countries.Include(x => x.Variants).AsNoTracking().FirstOrDefaultAsync(c => c.Id == id);
            if (id == null)
            {
                return NotFound();
            }
